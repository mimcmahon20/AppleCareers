...
export default function Homepage() {
  ...
  useEffect(() => {
    ...
    window.addEventListener("scroll", () => {
      ...
      if(secondTextUnderPhotoContainerRef.current.getBoundingClientRect().y <= 0) {
  ...
  return (
    <div className="homepage">
      <div className="hero-video-relative-container" ref={videoWrapperRef}>
        ...
        <section className="hero-text-container-secondary" ref={finalVideoTextRef}>
          <h1 className="hero-text">Set your sights high. Because experience is about more than work itself - it's about how you learn and who you learn from. At Apple, you`ll start a career doing important work with people who`ve made Apple what it is today. So that you can make it what it is tomorrow.</h1>
        </section>
      </div>
      ...
      <div className="text-location" ref={secondTextUnderPhotoContainerRef}>
        ...
        >
          <div className="text-section-container fixed">
            <h1 className="large-text padding-top">Apple Support College Advisor
</h1>
            <p className="small-text padding-bottom">
